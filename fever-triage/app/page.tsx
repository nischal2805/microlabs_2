  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="flex items-start">
            <div className="ml-3">
              ...
              <p className="text-gray-700 text-sm leading-relaxed">
                This is an AI assistant for <strong>educational and demonstration purposes only</strong>. 
        ...
        {showChatbot && (
          <Chatbot 
            assessmentContext={results ? `Recent assessment: ${results.severity} severity - ${results.recommended_action.slice(0, 100)}...` : undefined}
        ...
        <footer className="text-center mt-12 text-gray-600">
          <div className="max-w-2xl mx-auto">
            <p className="text-sm mb-4">
              Powered by AI • Built for healthcare professionals and educational use
            </p>
